...
public static void main(String[] args) {
	...
	String CodingHours = JOptionPane.showInputDialog(null, "How many hours have you spent coding this week?");
int CH = Integer.parseInt(CodingHours);
...
if (CH > 5) {
	JOptionPane.showMessageDialog(null, "One word for you, WOW!");
playBatmanTheme();
}
}
